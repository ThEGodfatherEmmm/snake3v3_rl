...
class RLAgent(object):
    ...
    def load_model(self, actor1, actor2, critic1, critic2):
        self.actor1.load_state_dict(torch.load(actor1))
        self.actor2.load_state_dict(torch.load(actor2))
        self.critic1.load_state_dict(torch.load(critic1))
        self.critic2.load_state_dict(torch.load(critic2))
...
actor1_net = os.path.dirname(os.path.abspath(__file__)) + "/actor1_5000.pth"
actor2_net = os.path.dirname(os.path.abspath(__file__)) + "/actor2_5000.pth"
critic1_net = os.path.dirname(os.path.abspath(__file__)) + "/critic1_5000.pth"
critic2_net = os.path.dirname(os.path.abspath(__file__)) + "/critic2_5000.pth"
